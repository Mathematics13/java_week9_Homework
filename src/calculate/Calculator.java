...
public class Calculator                                                      //Class Calculator
{
    ...
    void addition(int a, int b)                                         //instance non-static methods
    {
        int add = a+b;
        System.out.println("Addition of two numbers : " + add);
    }
    void subtraction(int a, int b)                                   //instance non-static methods
    {
        int sub = a-b;
        System.out.println("Subtraction of two numbers : " + sub);
    }
    void multiplication(int a, int b)                              //instance non-static methods
    {
        int mul = a*b;
        System.out.println("Multiplication of two numbers : " + mul);
    }
    void division(int a, int b)                                //instance non-static methods
    {
        if(b!=0)
        {
            int div =a/b;
        ...
        {
            System.out.println("Denominator can't be zero for division");
        }

    }
    void calculateResult(int a, int b , char symbol)        //instance non-static methods
    {
        switch(symbol)
        {
            case '+' :
            ...
            case '/' :
                ...
                break;
            default :
                System.out.println("Enter any one of the symbol from  +,-,*,/ ");
        }
    }
}
